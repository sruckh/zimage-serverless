...
- **Flash Attention 2:** Enabled at model load time via `pipe.transformer.set_attention_backend("flash")` when the `flash-attn` package is available (RTX 4090/5090 and newer). Falls back to PyTorch SDPA automatically.
