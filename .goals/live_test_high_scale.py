#!/usr/bin/env python3
"""Decisive test: push LoRA scale hard (2.5, effective ~1.25 after the
alpha/rank bake) to check whether the LoRA CAN produce a recognizable
identity match at all, isolating a real bug from a weak-LoRA/scale issue."""
import json
import re
import sys
import time
...
def build_job_input(env):
    return {
        ...
        "width": 864,
        "height": 1152,
        "loras": [{"url": env["TEST_LORA_URL"], "scale": 2.5}],
